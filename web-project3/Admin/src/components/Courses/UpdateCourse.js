...
const UpdateCourse = ({match}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('/course/update/'+match.params.id, {
                name,
                description,
                teacherName,
                teacherIntroduction, 
    ...
    return (
        <div className="container w-50 mt-4">
            ...
            <form onSubmit={handleSubmit(course._id)} encType='multipart/form-data'>
                <h4>Course Detail</h4>
                <div className="mb-3">
                ...
                <div className="mb-3 justify-content-end d-flex">
                    <button type="submit" className="btn btn-dark rounded">Update</button>
                </div>
